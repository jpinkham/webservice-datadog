...
__PACKAGE__->register_factory_type( alert => 'WebService::DataDog::Alert' );
__PACKAGE__->register_factory_type( dashboard => 'WebService::DataDog::Dashboard' );
__PACKAGE__->register_factory_type( event => 'WebService::DataDog::Event' );
